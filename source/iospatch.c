 ...
 * 
 * This code is a significantly modified version of the original, and was
 * obtained second-hand, in a similarly modified manner.
 * 
 * I *believe* that the original, unmodified code can be found here:
 * https://github.com/FIX94/Some-YAWMM-Mod/blob/e2708863036066c2cc8bad1fc142e90fb8a0464d/source/iospatch.c
 *
 * September 5, 2021
 * -ramblecube
 */
...
s32 IOSPATCH_Apply() {
	...
	if (AHBPROT_DISABLED) {
		...
		printf("!!AHBPROT NOT DISABLED!!\n"
			"Cannot possibly work without AHBPROT\n"
			"Make sure your Homebrew Channel is updated to 1.0.8 or newer and is using an unmodified IOS 58\n"
			"Make sure the meta.xml for this program has the <ahb_access/> tag\n");
		return ENOAHB;
	}
	return count;
}